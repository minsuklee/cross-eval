...
| 화면 | 파일 | 설명 |
|------|------|------|
| 과목 선택 | `admin/courses.html` | **과목 목록 카드**, "새 과목 만들기" 버튼, **과목 삭제/복원 버튼** |
